...
"[project]/node_modules/react-audio-voice-recorder/dist/react-audio-visualize.es-69216c73.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function dr() {
    if (je) return z;
    je = 1;
    var y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], m = Symbol.for("react.element"), _ = Symbol.for("react.fragment"), b = Object.prototype.hasOwnProperty, h = y.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, w = {
        key: !0,
        ref: !0,
        __self: !0,
        __source: !0
    ...
    function k(i, s, g) {
        ...
        for(o in s)b.call(s, o) && !w.hasOwnProperty(o) && (a[o] = s[o]);
        if (i && i.defaultProps) for(o in s = i.defaultProps, s)a[o] === void 0 && (a[o] = s[o]);
        return {
            $$typeof: m,
            type: i,
            key: d,
...
`), O = n.stack.split(`
`), S = c.length - 1, R = O.length - 1; S >= 1 && R >= 0 && c[S] !== O[R];)R--;
                    for(; S >= 1 && R >= 0; S--, R--)if (c[S] !== O[R]) {
                        if (S !== 1 || R !== 1) do if (S--, R--, R < 0 || c[S] !== O[R]) {
                            var P = `
` + c[S].replace(" at new ", " at ");
        ...
        function U(e, r, t) {
            if (e == null) return "";
            if (typeof e == "function") return de(e, Ve(e));
        ...
        function he(e) {
            if (Xe(e)) return f("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", He(e)), ve(e);
        }
        ...
        function tr(e, r, t, n, p) {
            {
                ...
                for(v in r)B.call(r, v) && !Je.hasOwnProperty(v) && (u[v] = r[v]);
                if (e && e.defaultProps) {
                    var S = e.defaultProps;
                    for(v in S)u[v] === void 0 && (u[v] = S[v]);
                }
                if (c || O) {
        ...
        function Ee(e, r) {
            {
                ...
                if (Q(e)) for(var t = 0; t < e.length; t++){
                    var n = e[t];
                    re(n) && _e(n, r);
                }
                    ...
                    var p = D(e);
                    if (typeof p == "function" && p !== e.entries) for(var v = p.call(e), u; !(u = v.next()).done;)re(u.value) && _e(u.value, r);
                }
            }
        }
        function ar(e) {
        ...
        function Ce(e, r, t, n, p, v) {
            {
                ...
                if (u) {
                    var P = r.children;
                    if (P !== void 0) if (n) if (Q(P)) {
                        for(var A = 0; A < P.length; A++)Ee(P[A], e);
...
("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ne.exports = mr();
var $e = ne.exports;
const gr = (y, m, _, b)=>{
    ...
    for(let i = 0; i < h; i++){
        let s = 0;
        for(let g = 0; g < w && i * w + g < y.length; g++)s += y[i * w + g];
        k.push(s / w);
    }
    return k;
}, vr = (y, m, _, b, h, w)=>{
...
}, Sr = ({ mediaRecorder: y, width: m = "100%", height: _ = "100%", barWidth: b = 2, gap: h = 1, backgroundColor: w = "transparent", barColor: k = "rgb(160, 198, 255)", fftSize: i = 1024, maxDecibels: s = -10, minDecibels: g = -90, smoothingTimeConstant: o = 0.4 })=>{
    const [a] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>new AudioContext()), [d, E] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(), C = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const T = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!d) return;
        ...
        if (!C.current) return;
        const f = gr(l, C.current.width, b, h);
        vr(f, C.current, b, h, w, k);
    };
    return /* @__PURE__ */ $e.jsx("canvas", {
        ref: C,
        width: m,
        height: _,
        style: {
    ...
    for(let a = 0; a < k; a++){
        ...
        const D = d.reduce((f, j)=>f + j, 0) / E, l = {
            max: C.reduce((f, j)=>f + j, 0) / T,
            min: D
        };
...
}, br = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["forwardRef"])(({ blob: y, width: m, height: _, barWidth: b = 2, gap: h = 1, currentTime: w, style: k, backgroundColor: i = "transparent", barColor: s = "rgb(184, 184, 184)", barPlayedColor: g = "rgb(160, 198, 255)" }, o)=>{
    const a = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRef"])(null), [d, E] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]), [C, T] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useImperativeHandle"])(o, ()=>a.current, []), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (async ()=>{
            if (!a.current) return;
            if (!y) {
                const l = Array.from({
            ...
            await new AudioContext().decodeAudioData(D, (l)=>{
                if (!a.current) return;
                T(l.duration);
                const f = hr(l, _, m, b, h);
                E(f), te(f, a.current, b, h, i, s, g);
            });
        })();
    }, [
        y,
        ...
        a.current && te(d, a.current, b, h, i, s, g, w, C);
    }, [
        w,
        C
...
//# sourceMappingURL=8069e_react-audio-voice-recorder_dist_react-audio-visualize_es-69216c73_aef542.js.map