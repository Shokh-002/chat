(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_react-audio-voice-recorder_dist_index-1c988149_2f0f77.js", {

"[project]/node_modules/react-audio-voice-recorder/dist/index-1c988149.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_resolve_absolute_path__("node_modules/react-audio-voice-recorder/dist/index-1c988149.js")}`;
    }
};
function re(o, f) {
    for(var s = 0; s < f.length; s++){
        ...
        if (typeof p != "string" && !Array.isArray(p)) {
            for(const c in p)if (c !== "default" && !(c in o)) {
...
(function(o) {
    var f = function(s) {
        ...
        T.prototype = k, w($, "constructor", k), w(k, "constructor", T), T.displayName = w(k, v, "GeneratorFunction");
        function Y(t) {
            [
                "next",
                "throw",
        ...
        function I(t, e) {
            ...
            function n(d, b) {
                ...
                return i = // all previous Promises have been resolved before calling invoke,
                ...
                i ? i.then(F, // Avoid propagating failures to Promises returned by later
            ...
            return function(d, b) {
                ...
                for(r.method = d, r.arg = b;;){
                    ...
                    if (r.method === "next") r.sent = r._sent = r.arg;
                        ...
                        if (i === _) throw i = P, r.arg;
                        r.dispatchException(r.arg);
                    } else r.method === "return" && r.abrupt("return", r.arg);
                    i = U;
                    var E = N(t, e, r);
                    if (E.type === "normal") {
                        if (i = r.done ? P : G, E.arg === L) continue;
                        return {
                            value: E.arg,
                            done: r.done
                        };
                    } else E.type === "throw" && (i = P, r.method = "throw", r.arg = E.arg);
                }
            };
        }
        function q(t, e) {
            ...
            if (r === l) {
                if (e.delegate = null, e.method === "throw") {
                    if (t.iterator.return && (e.method = "return", e.arg = l, q(t, e), e.method === "throw")) return L;
                    e.method = "throw", e.arg = new TypeError("The iterator does not provide a 'throw' method");
                }
                return L;
            }
            var i = N(r, t.iterator, e.arg);
            if (i.type === "throw") return e.method = "throw", e.arg = i.arg, e.delegate = null, L;
            var n = i.arg;
            if (!n) return e.method = "throw", e.arg = new TypeError("iterator result is not an object"), e.delegate = null, L;
            if (n.done) e[t.resultName] = n.value, e.next = t.nextLoc, e.method !== "return" && (e.method = "next", e.arg = l);
            else return n;
            ...
            if (t) {
                ...
                if (!isNaN(t.length)) {
                    var r = -1, i = function n() {
                        for(; ++r < t.length;)if (c.call(t, r)) return n.value = t[r], n.done = !1, n;
        ...
        return u.prototype = {
            constructor: u,
            reset: function(t) {
                if (this.prev = 0, this.next = 0, this.sent = this._sent = l, this.done = !1, this.delegate = null, this.method = "next", this.arg = l, this.tryEntries.forEach(a), !t) for(var e in this)e.charAt(0) === "t" && c.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = l);
            },
            stop: function() {
                this.done = !0;
...
var ae = {
    ...
    baseOptions: {
        /* Flag to turn on/off log messages in console */ log: !1,
        /*
...
const fe = "@ffmpeg/ffmpeg", ce = "0.11.6", le = "FFmpeg WebAssembly version", pe = "src/index.js", ue = "src/index.d.ts", he = {
    ...
    dependencies: je,
    devDependencies: Le
}, Oe = typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] < "u" && ("TURBOPACK compile-time value", "development") === "development" ? new URL("/node_modules/@ffmpeg/core/dist/ffmpeg-core.js", self.location).href : `https://unpkg.com/@ffmpeg/core@${Q.devDependencies["@ffmpeg/core"].substring(1)}/dist/ffmpeg-core.js`, Se = {
    corePath: Oe
};
let Z = !1, X = ()=>{};
const _e = (o)=>{
...
const W = async (o, f)=>{
...
}, Ce = async ({ corePath: o, workerPath: f, wasmPath: s })=>{
    if (typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope) {
        if (typeof o != "string") throw Error("corePath should be a string!");
        const y = new URL(o, __TURBOPACK__import$2e$meta__.url).href, m = await W(y, "application/javascript"), v = await W(s !== void 0 ? s : y.replace("ffmpeg-core.js", "ffmpeg-core.wasm"), "application/wasm"), w = await W(f !== void 0 ? f : y.replace("ffmpeg-core.js", "ffmpeg-core.worker.js"), "application/javascript");
        return typeof createFFmpegCore > "u" ? new Promise((C)=>{
            if (globalThis.importScripts(m), typeof createFFmpegCore > "u") throw Error(K.CREATE_FFMPEG_CORE_IS_NOT_DEFINED(y));
    ...
    if (typeof o != "string") throw Error("corePath should be a string!");
    const p = new URL(o, __TURBOPACK__import$2e$meta__.url).href, c = await W(p, "application/javascript"), l = await W(s !== void 0 ? s : p.replace("ffmpeg-core.js", "ffmpeg-core.wasm"), "application/wasm"), j = await W(f !== void 0 ? f : p.replace("ffmpeg-core.js", "ffmpeg-core.worker.js"), "application/javascript");
    return typeof createFFmpegCore > "u" ? new Promise((y)=>{
        const m = document.createElement("script"), v = ()=>{
            if (m.removeEventListener("load", v), typeof createFFmpegCore > "u") throw Error(K.CREATE_FFMPEG_CORE_IS_NOT_DEFINED(p));
    ...
    let f = o;
    return typeof o > "u" ? new Uint8Array() : (typeof o == "string" ? /data:_data\/([a-zA-Z]*);base64,([^"]*)/.test(o) ? f = atob(o.split(",")[1]).split("").map((s)=>s.charCodeAt(0)) : f = await (await fetch(new URL(o, __TURBOPACK__import$2e$meta__.url).href)).arrayBuffer() : (o instanceof File || o instanceof Blob) && (f = await Te(o)), new Uint8Array(f));
    ...
    value: "Module"
})), ee = /* @__PURE__ */ ne(Ae), { defaultArgs: Ne, baseOptions: Ge } = ae, Ue = se, { defaultOptions: De, getCreateFFmpegCore: Me } = ee, { version: Ie } = Q, J = Error("ffmpeg.wasm is not ready, make sure you have completed load().");
var We = (o = {})=>{
    const { log: f, logger: s, progress: p, ...c } = {
        ...Ge,
        ...De,
        ...o
    };
    let l = null, j = null, y = null, m = null, v = !1, w = ()=>{}, C = f, N = p, _ = 0, G = 0, U = !1, P = 0;
    const L = (a)=>{
        ...
        if (typeof a == "string") if (a.startsWith("  Duration")) {
        ...
        if (O("info", "load ffmpeg-core"), l === null) {
            ...
            const { createFFmpegCore: a, corePath: u, workerPath: h, wasmPath: g } = await Me(c);
            l = await a({
                /*
         ...
         */ locateFile: (t, e)=>{
                    if (typeof window < "u" || typeof WorkerGlobalScope < "u") {
                        if (typeof g < "u" && t.endsWith("ffmpeg-core.wasm")) return g;
                        if (typeof h < "u" && t.endsWith("ffmpeg-core.worker.js")) return h;
                    }
                    return e + t;
                }
            }), j = l.cwrap(c.mainName || "proxy_main", "number", [
                "number",
                "number"
            ]), O("info", "ffmpeg-core loaded");
        } else throw Error("ffmpeg.wasm was loaded, you should not load it again, use ffmpeg.isLoaded() to check next time.");
    }, M = ()=>l !== null, $ = (...a)=>{
        if (O("info", `run ffmpeg command: ${a.join(" ")}`), l === null) throw J;
        if (v) throw Error("ffmpeg.wasm can only run one command at a time");
        ...
        if (O("info", `run FS.${a} ${u.map((h)=>typeof h == "string" ? h : `<${h.length} bytes binary file>`).join(" ")}`), l === null) throw J;
        {
            let h = null;
            try {
                h = l.FS[a](...u);
...
//# sourceMappingURL=node_modules_react-audio-voice-recorder_dist_index-1c988149_2f0f77.js.map